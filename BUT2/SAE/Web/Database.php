...
require __DIR__."/paramMaxence.php";
//require __DIR__."/paramOVH.php";
//require  __DIR__."/paramMathis.php";
//require __DIR__."/paramProxMox.php";
...
class Database
{
    ...
    */
     ...
     * @param $idADM int L'id de l'activité du moment à modifier
     * @param $ListeIdCompetences array Liste des compétences à ajouter ou retirer
     * @return void
     * @throws Exception
     */
