...
<body class="scroll_div_element scrollbar_style_1">
    ...
    <main id="page_educateur_categories">
        ...
        <div class="flex_row flex_double_center fill flex_wrap space_around">
            <a href="#" class="button_style_2 <?php echo $Personne["type"]=="responsable"?"active":"inactive";?>" onclick='popActive("ajouter_nouvelle_categorie");'>Créer une nouvelle Catégorie</a>
            <a id="bouton_nouvelle_competence" href="#" class="button_style_2" onclick='popActive("ajouter_nouvelle_competence");'>Créer une nouvelle Compétence</a>
        </div>
